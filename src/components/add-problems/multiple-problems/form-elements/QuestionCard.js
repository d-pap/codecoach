...
// Dynamically import MUI icons with named exports
const DeleteIcon = lazy(() =>
  import('@mui/icons-material/Delete').then(module => ({ default: module.Delete }))
)
const AddIcon = lazy(() =>
  import('@mui/icons-material/Add').then(module => ({ default: module.Add }))
)
