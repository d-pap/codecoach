  ...
  return (
    ...
    >
      ...
      <DialogContent dividers>
        ...
        >
          Please ensure that you have not included any sensitive personal
          information such as names, addresses, emails, phone numbers, etc.,
          before generating your resume.
        </DialogContentText>
        <Typography variant="body2" color="text.quaternary">
          Including personal information can compromise your privacy. If you're
          certain that your inputs are free from such data, you can proceed to
