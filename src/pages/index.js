        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <OnboardingCard elevation={3}>
              ...
              <Button variant="contained" sx={{ marginTop: 2 }}>Get Started</Button>
            </OnboardingCard>
          </Grid>
          <Grid item xs={12} md={6}>
            <StreakCard elevation={3}>
              ...
              <Link href="#" sx={{ marginTop: 2 }}>View Profile</Link>
            </StreakCard>
          </Grid>
        </Grid>
      </Box>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <RoadmapCard elevation={3}>
              ...
              <Typography variant="body2">977 Problems • 400k+ learners</Typography>
              <Typography variant="body2">Learn the basics of Python and data structures. Use practice modules to boost your coding and logic skills.</Typography>
            </RoadmapCard>
          </Grid>
          <Grid item xs={12} md={6}>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ padding: 3 }}>
              ...
              <Typography variant="body2">You have not bookmarked any problem yet.</Typography>
              <Link href="#" sx={{ marginTop: 2 }}>Know more</Link>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ padding: 3 }}>
              <Typography variant="h6">Explore Our Blogs Today</Typography>
              <Typography variant="body2">Read blogs about various topics in programming. Get expert guidance from CodeChef on coding.</Typography>
              <Link href="#" sx={{ marginTop: 2 }}>View all</Link>
            </Paper>
          </Grid>
        </Grid>
      </Box>
