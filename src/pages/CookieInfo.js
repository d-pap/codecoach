...
const CookieInfo = () => {
  ...
  return (
    <PageLayout
      overline="Cookie Policy"
      title="Learn about how we use cookies on our website"
      subtitle="We utilize cookies solely for convenience. They remember your preferences, such as chosen programming languages and other configurations to improve your user experience."
    >
          ...
          <List>
              ...
              <ListItemText
                primary={
                  <Typography variant="body1">
                    ...
                    However, you have the option to disable them if you prefer.
                  </Typography>
                }
              />
            </ListItem>
            ...
            <ListItem alignItems="flex-start">
              ...
              <ListItemText
                primary={
                  <Typography variant="body1">
                    Removing cookies will not restrict your access to any of our
                    features.
                  </Typography>
                }
              />
            ...
            <ListItem alignItems="flex-start">
              ...
              <ListItemText
                primary={
                  <Typography variant="body1">
                    Disabling cookies will erase all your preferences, requiring
                    you to reset them once cookies are re-enabled.
                  </Typography>
                }
              />
            </ListItem>
