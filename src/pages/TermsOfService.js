...
const TermsOfService = () => {
  return (
    <PageLayout
      overline="Current as of 18 Nov 2024"
      title="Terms of Service"
      subtitle="Transparency is important to us at CodeCoach. We respect your privacy and are committed to providing you with a fair set of terms to guide how you interact with our platform."
    >
      <StyledCard>
        <CardContent>
          {/* Introduction */}
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            By registering for, accessing, browsing, or using our Services, you
            acknowledge that you have read, understood, and agree to be bound by
            these Terms and our <a href="/terms-of-service">Privacy Policy</a>.
          </Typography>
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            Our platform is an AI-driven educational tool designed to assist ACM
            or University of Michigan students in mastering the skills required
            to solve programming questions and prepare for technical job
            interviews. Key features include:
          </Typography>
          <List sx={{ pl: 2 }}>
            ...
            <ListItem disablePadding>
              <ListItemText
                primary={
                  <Typography variant="body1">
                    <strong>Discussion Forum:</strong> A collaborative space for
                    problem discussion and solution sharing.
                  </Typography>
                }
              />
            </ListItem>
          ...
          <List sx={{ pl: 2 }}>
            <ListItem disablePadding>
              <ListItemText
                primary={
                  <Typography variant="body1">
                    <strong>Code Submissions:</strong> Stored for the assessment
                    of your answers.
                  </Typography>
                }
              />
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            You agree to indemnify, defend, and hold harmless CodeCoach, its
            ...
            expenses arising from your use of and access to the Services, or
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            ...
            notify you of significant changes by posting a notice on our website
            or sending an email. Your continued use of the Services after
